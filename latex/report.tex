...
\paragraph{Problema}
Eliminare gli attacchi processati.
\paragraph{Soluzione}
Ho ideato il \texttt{ClearAttackSystem} il quale si occupa di eliminare gli attacchi
che hanno colliso con le entità nemiche.
Questo sistema distungue gli attachi da distanza da quelli ravvicinati sfruttando 
due \textit{"Tag Component"}: \texttt{MeleeComponent}
ed \texttt{BulletComponent}, distinzione utile ad eliminare gli soltanto gli attachi 
ravvicinati (di durata istantanea) anche se non hanno colpito l'entiyà puntata. 
