...
\begin{itemize}
	\item uso della libreria jts (\href[]{https://github.com/locationtech/jts}{link alla pagina github}) sia per la classe \texttt{Vector2D} che e' usata in tutto il progetto, sia per utilizzare le api della libreria per creare facilmente forme geometriche di interfaccia \texttt{Polygon} che tra l'altro forniscono anche metodi gia' implementati per controllare le intersezioni tra poligoni
	\item reflection e stream nella classe \texttt{EntityImpl} \url{https://github.com/LorenzoPrati/OOP22-dim-hol/blob/5d2b44fc5bf5fa50b6f0215695d2a5bac89cab85/src/main/java/dimhol/entity/EntityImpl.java#L61-L89}
	\item stream utilizzati anche in \texttt{RemoveEntityEvent} e in \texttt{WorldImpl} e nel metodo template di \texttt{AbstractSystem} [links], e in minima parte in altri punti del codice
