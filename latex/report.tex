...
\paragraph{Soluzione}
L'architettura è costruita in modo tale da permettere la creazione di nuovi 
System anche solo per eseguire piccole operazioni quindi ho ideato il 
...
che bastassero pochi semplici metodi utili al aggiornamento 
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{uml/RoomStrategy.png}
	\caption{Diagramma UML sulla gestione delle startegie nelle stanze}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{uml/Boss.png}
	\caption{Diagramma UML della Boss entity}
\end{figure}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item classe \texttt{InvalidEntityDimensionsException}
		\item interfaccia \texttt{LevelManager}
		\item classe \texttt{LevelManagerImpl}
		\item classe \texttt{NoAvailableTilesException}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item classe \texttt{HealRegenerationAction}
			\end{itemize}
		\end{itemize}
	\end{itemize}
	\item Package systems
