...
public class PlayerBullet extends AbstractDynamicObject implements Bullet {

    private final int damage;

    public PlayerBullet(Coordinate position, Integer id, ObjectType type, State state, CollisionBox collisionBox,
